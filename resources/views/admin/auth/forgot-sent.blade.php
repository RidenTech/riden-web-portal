                ...
                <div class="col-lg-6 col-md-7 form-side d-flex align-items-center p-4 p-lg-5">
                    <div class="w-100 text-center">
                        <div class="mb-4">
                            ...
                            <p class="sub-text">We've send you the password link to your email jesseshowalter@gmail.com</p>
                        </div>

                        <div class="mt-5">
                            <a href="reset.html" class="btn btn-login w-100 text-decoration-none d-block">Resend Link</a>
                        </div>
                    </div>
                </div>
            </div>
