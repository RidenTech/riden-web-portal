        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit: {{ $vehicle->license_plate }}</li>
                </ol>
            </nav>
            <h2 class="riden-section-title mb-0">Edit Vehicle</h2>
        </div>
        ...
        <form action="{{ route('admin.vehicle.update', $vehicle->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="riden-form-card">
                <div class="row">
                    ...
                    <div class="col-md-4 border-end pe-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="model" class="form-control @error('model') is-invalid @enderror" placeholder="e.g. Toyota Corolla" value="{{ old('model') ?? $vehicle->model }}">
                            @error('model') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Plate No</label>
                            <input type="text" name="license_plate" class="form-control @error('license_plate') is-invalid @enderror" placeholder="e.g. ABC-123" value="{{ old('license_plate') ?? $vehicle->license_plate }}">
                    ...
                    <div class="col-md-4 border-end px-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="year" class="form-control @error('year') is-invalid @enderror" placeholder="2023" value="{{ old('year') ?? $vehicle->year }}">
                                @error('year') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Color</label>
                                <input type="text" name="color" class="form-control @error('color') is-invalid @enderror" placeholder="White" value="{{ old('color') ?? $vehicle->color }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="vehicle_type" class="form-select @error('vehicle_type') is-invalid @enderror">
                                ...
                                <option value="luxury" {{ (old('vehicle_type') ?? $vehicle->vehicle_type) == 'luxury' ? 'selected' : '' }}>Luxury</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="no_of_seats" class="form-control @error('no_of_seats') is-invalid @enderror" placeholder="4" value="{{ old('no_of_seats') ?? $vehicle->no_of_seats }}">
                    ...
                    <div class="col-md-4 ps-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="image-upload-wrapper text-center">
                                <div class="preview-container mb-2" style="height: 120px; border: 2px dashed #e0e0e0; border-radius: 10px; overflow: hidden; display: flex; align-items: center; justify-content: center; background: #fafafa;">
                                    <img id="front-preview" src="{{ $vehicle->front_image ? asset('uploads/vehicles/' . $vehicle->front_image) : '#' }}" alt="Front Preview" style="max-width: 100%; max-height: 100%; {{ $vehicle->front_image ? '' : 'display: none;' }}">
                                    <i class="bi bi-camera text-muted fs-2" id="front-icon" style="{{ $vehicle->front_image ? 'display: none;' : '' }}"></i>
                                </div>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="image-upload-wrapper text-center">
                                <div class="preview-container mb-2" style="height: 120px; border: 2px dashed #e0e0e0; border-radius: 10px; overflow: hidden; display: flex; align-items: center; justify-content: center; background: #fafafa;">
                                    <img id="back-preview" src="{{ $vehicle->back_image ? asset('uploads/vehicles/' . $vehicle->back_image) : '#' }}" alt="Back Preview" style="max-width: 100%; max-height: 100%; {{ $vehicle->back_image ? '' : 'display: none;' }}">
                                    <i class="bi bi-camera text-muted fs-2" id="back-icon" style="{{ $vehicle->back_image ? 'display: none;' : '' }}"></i>
                                </div>
                ...
                <div class="d-flex justify-content-end gap-3 text-center">
                    ...
                    <button type="submit" class="riden-btn-primary px-5 py-2">Update Vehicle</button>
                </div>
            </div>
        </form>
    </div>
