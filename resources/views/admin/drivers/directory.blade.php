...
<div class="col-12 drivers-wrapper">
    ...
    <div class="drivers-tabs">
        <a href="{{ route('drivers.directory') }}" class="btn-tab-driver active">Active Drivers</a>
        <a href="{{ route('drivers.requests') }}" class="btn-tab-driver">Requested <span class="count">(14)</span></a>
    </div>
