...
<div class="reviews-container">
    ...
    <div class="reviews-tabs-container">
        <a href="{{ route('reviews.ratings', ['tab' => 'drivers']) }}" class="review-tab-item">Drivers Reviews</a>
        <a href="{{ route('reviews.ratings', ['tab' => 'passengers']) }}" class="review-tab-item active">Passengers Reviews</a>
    </div>
    ...
    <div class="reviews-list">
        @php
            $reviews = [
                ['name' => 'Floyd Miles', 'rating' => '4.5', 'date' => '22-02-2025 09:30pm', 'id' => '#34565', 'by' => 'Driver Ronald Richards'],
                ['name' => 'Floyd Miles', 'rating' => '4.5', 'date' => '22-02-2025 09:30pm', 'id' => '#34565', 'by' => 'Driver Ronald Richards'],
                ['name' => 'Floyd Miles', 'rating' => '4.5', 'date' => '22-02-2025 09:30pm', 'id' => '#34565', 'by' => 'Driver Ronald Richards'],
            ];
        @endphp
